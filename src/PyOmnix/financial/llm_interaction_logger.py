...
from backend.schemas import AgentExecutionLog, LLMInteractionLog
from backend.storage.base import BaseLogStorage

from .agents.serialization import serialize_agent_state
...
log_storage_context: ContextVar[BaseLogStorage | None] = ContextVar(
...
current_run_id_context: ContextVar[str | None] = ContextVar(
