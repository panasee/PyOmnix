...
def risk_management_agent(state: AgentState):
    ...
    # 使用60天窗口计算最大回撤
    max_drawdown = (
        prices_df["close"] / prices_df["close"].rolling(window=60).max() - 1
    ).min()
    ...
    elif debate_signal == "bullish" and debate_confidence > 0.5:
        trading_action = "buy"
    ...
    return {
        ...
        "data": {**data, "risk_analysis": message_content},
