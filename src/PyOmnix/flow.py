...
class WorkflowManager:
    ...
    def add_task(self, 
        ...
        def task_wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.error(f"Task '{task_id}' in DAG '{dag_id}' failed: {str(e)}")
                raise
        
        # Add task instance to op_kwargs
        if 'ti' not in op_kwargs:
    ...
    def execute_task(self, task_id: str, execution_date: datetime.datetime = None, **kwargs) -> Any:
        ...
        # Execute the task
        return task.python_callable(**op_kwargs)
...
if __name__ == "__main__":
    ...
    t2 = workflow.add_task(
        ...
        op_kwargs={"task1_result": "{{ ti.xcom_pull(task_ids='task1')['task1_result'] }}"}
    )
